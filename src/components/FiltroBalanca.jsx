 ...
 */
export default function FiltroBalanca({ periodo, grupo, produto }) {
    return (
        <aside className="flex w-full shrink-0 flex-col rounded-[10px] border border-[#d9d9d9] bg-white p-4 lg:sticky lg:top-4 lg:w-[287px]">
